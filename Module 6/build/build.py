"""
Build the Module 6 study PDFs in the SA Bullion / Treasury-Brain house style.
...
JOBS = [
    (
        ...
        os.path.join(MOD, "Summarised work book",
                     "Module 6 — Derivatives Markets & Alternative Investments (Summarised Reference).pdf"),
    ),
    (
        "mod6-workbook.html",
        os.path.join(MOD, "Full in depth study material",
                     "Module 6 — Derivatives Markets & Alternative Investments (In-Depth Workbook).pdf"),
    ),
    (
        "mod6-workbook-answers.html",
        os.path.join(MOD, "assignment",
                     "Module 6 — Derivatives Markets & Alternative Investments (Workbook Answers).pdf"),
    ),
]
